...
import HardHats from './HardHats.component';
...
const HardHatsContainer = ({ navigation }: Props): JSX.Element => {
    ...
    useEffect(() => {
        ...
        WooCommerce.get('/products?category=183&').then(({ data }) => {
            setProducts(data);
        });
    }, []);

    return <HardHats{...handlers} products={products} />;

};

    export default HardHatsContainer;
