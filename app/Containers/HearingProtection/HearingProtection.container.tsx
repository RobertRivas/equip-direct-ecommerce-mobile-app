...
import HearingProtection from './HearingProtection.component';
...
const HearingProtectionContainer = ({ navigation }: Props): JSX.Element => {
    ...
    useEffect(() => {
        ...
        WooCommerce.get('/products?category=344&').then(({ data }) => {
            setProducts(data);
        });
    }, []);

    return <HearingProtection{...handlers} products={products} />;
