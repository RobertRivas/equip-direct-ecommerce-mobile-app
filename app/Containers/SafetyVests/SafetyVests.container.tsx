...
import SafetyVests from './SafetyVests.component';
...
const SafetyVestsContainer = ({ navigation }: Props): JSX.Element => {
    ...
    useEffect(() => {
        ...
        WooCommerce.get('/products?category=632&').then(({ data }) => {
            setProducts(data);
        });
    }, []);

    return <SafetyVests{...handlers} products={products} />;

};

export default SafetyVestsContainer;
