...
import LibertyGloves from './LibertyGloves.component';
...
const LibertyGlovesContainer = ({ navigation }: Props): JSX.Element => {
    ...
    useEffect(() => {
        ...
        WooCommerce.get('/products?category=718&').then(({ data }) => {
            setProducts(data);
        });
    }, []);

    return <LibertyGloves{...handlers} products={products} />;

};

        export default LibertyGlovesContainer;
